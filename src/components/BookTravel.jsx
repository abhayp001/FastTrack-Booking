...
// import { FaUser, FaMapMarkerAlt, FaCalendarAlt, FaSuitcase, FaDollarSign } from 'react-icons/fa'; // Importing relevant icons
...
function BookTravel() {
  ...
  const handleSubmit = async (e) => {
    ...
    const apiUrl = `${BACKEND_URL}/api/auth/update/Abhay`; // Change this to your actual backend route for storing travel data
